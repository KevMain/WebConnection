...
namespace CCE.WebConnection.DAL.FactoryClasses
{
	...
	{
		private readonly CCE.WebConnection.DAL.EntityType _typeOfEntity;
		...
		public EntityFactoryBase2(string entityName, CCE.WebConnection.DAL.EntityType typeOfEntity, bool isInHierarchy) : base(entityName)
		{
		...
		{
			return GeneralEntityFactory.Create((CCE.WebConnection.DAL.EntityType)entityTypeValue);
		}
	...
	public partial class CustomerEntityFactory : EntityFactoryBase2<CustomerEntity> {
		/// <summary>CTor</summary>
		public CustomerEntityFactory() : base("CustomerEntity", CCE.WebConnection.DAL.EntityType.CustomerEntity, false) { }
	...
	public partial class GeneralEntityFactory
	{
		...
		public static IEntity2 Create(CCE.WebConnection.DAL.EntityType entityTypeToCreate)
		{
			IEntityFactory2 factoryToUse = null;
			switch(entityTypeToCreate)
			{
				case CCE.WebConnection.DAL.EntityType.CustomerEntity:
	...
	{
#if CF
		/// <summary>Gets the factory of the entity with the CCE.WebConnection.DAL.EntityType specified</summary>
		/// <param name="typeOfEntity">The type of entity.</param>
		/// <returns>factory to use or null if not found</returns>
		public static IEntityFactory2 GetFactory(CCE.WebConnection.DAL.EntityType typeOfEntity)
		{
		...
		{
			Array entityTypeValues = Enum.GetValues(typeof(CCE.WebConnection.DAL.EntityType));
			foreach(int entityTypeValue in entityTypeValues)
			{
				IEntity2 dummy = GeneralEntityFactory.Create((CCE.WebConnection.DAL.EntityType)entityTypeValue);
	...
	{
		/// <summary>Gets the factory of the Entity type with the CCE.WebConnection.DAL.EntityType value passed in</summary>
		...
		{
			return new DynamicRelation(leftOperand, joinType, (CCE.WebConnection.DAL.EntityType)Enum.Parse(typeof(CCE.WebConnection.DAL.EntityType), rightOperandEntityName, false), aliasRightOperand, onClause);
		}
		...
		{
			return new DynamicRelation((CCE.WebConnection.DAL.EntityType)Enum.Parse(typeof(CCE.WebConnection.DAL.EntityType), leftOperandEntityName, false), joinType, (CCE.WebConnection.DAL.EntityType)Enum.Parse(typeof(CCE.WebConnection.DAL.EntityType), rightOperandEntityName, false), aliasLeftOperand, aliasRightOperand, onClause);
		}
		...
		/// <summary>Implementation of the routine which gets the factory of the Entity type with the CCE.WebConnection.DAL.EntityType value passed in</summary>
		/// <param name="entityTypeValue">The entity type value.</param>
		/// <returns>the entity factory of the entity type or null if not found</returns>
		protected override IEntityFactoryCore GetFactoryImpl(int entityTypeValue)
		{
			return EntityFactoryFactory.GetFactory((CCE.WebConnection.DAL.EntityType)entityTypeValue);
		}
#if !CF		
